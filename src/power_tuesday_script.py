...
try:
  ...
  # message = Shield.sendCommand("DEAD_TIME_RISING","LEG2",200)
  # print(message)

  # message = Shield.sendCommand("DEAD_TIME_FALLING","LEG2",100)
  # print(message)


  message1 = Shield.sendCommand("PHASE_SHIFT","LEG1",0)
  print(message1)
